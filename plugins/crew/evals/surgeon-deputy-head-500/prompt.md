---
description: Every page raises RelatedObjectDoesNotExist for a user with no Membership row, because _school_for reads user.membership unguarded. Reported as "the dashboard gives a 500 for one new user". The Surgeon must build a red loop, name the real cause, and change nothing.
