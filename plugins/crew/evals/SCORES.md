...
| 2.14.0 | 2026-09-20 | | | | | | | | | | | | | | Surgeon and Lookout descriptions say to use the agent proactively, before answering; character text trimmed to pay for it. Re-run of surgeon*: still not dispatched (0.71 / not run); the description is not the lever. 2.14.1 sends both prompts through /crew:captain instead. Harder Gunner and Surgeon cases: issues #9 and #10. |
