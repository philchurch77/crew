...
| 2.14.0 | 2026-09-20 | | | | | | | | | | | | | | Surgeon and Lookout descriptions say to use the agent proactively, before answering; character text trimmed to pay for it. Re-run surgeon* and lookout* and read the dispatch line. Harder Gunner and Surgeon cases: issues #9 and #10. |
